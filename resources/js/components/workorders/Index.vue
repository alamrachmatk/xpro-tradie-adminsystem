                ...
                <div class="container-fluid">
                    ...
                    <div class="box-body">
                        ...
                        <template v-slot:cell(description)="data">
                            <span v-if="data.item.new_order.description.length < 10">{{ data.item.new_order.description }}</span>
                            <span v-else> {{ data.item.new_order.description.substring(0,50)+"....." }} </span>
                        </template>
                        <template v-slot:cell(status)="data">
                            <b-badge pill class="badge badge-danger" v-if="data.item.status == '0'">CANCEL</b-badge>
                            <b-badge pill class="badge badge-success" v-if="data.item.status == '1'">READY</b-badge>
                            <b-badge pill class="badge badge-warning" v-if="data.item.status == '2'">PENDING</b-badge>
                            <b-badge pill class="badge badge-info" v-if="data.item.status == '3'">ONGOING</b-badge>
                        </template>
...
export default {
    ...
    methods: {
        getAllWorkOrder() {
            let uri = 'http://localhost:8000/api/workorders';
