          ...
          <div class="box">
                  ...
                  <b-row align-v="center">
                    ...
                    <b-col cols="*">
                      <b-button
                        ...
                        @click="openBiddingModal(data.item)"
                        v-b-tooltip.hover
                        title="Bidding"
                      >
            ...
            >
              <b-form @submit.prevent="bidding" enctype="multipart/form-data">
                <b-form-input id="orderID" v-model="form.orderID" hidden>
                </b-form-input>
                <b-form-input id="companyID" v-model="form.companyID" hidden>
                </b-form-input>
                <b-form-group label="Labor Time" label-for="laborTimeInput">
                  <b-form-input
                    id="laborTimeInput"
